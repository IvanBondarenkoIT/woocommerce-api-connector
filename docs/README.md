...
- [TESTING_STRATEGY.md](development/TESTING_STRATEGY.md) - Стратегия тестирования
- [TESTING_SUMMARY.md](development/TESTING_SUMMARY.md) - Сводка по тестированию
- [REFACTORING_PLAN.md](development/REFACTORING_PLAN.md) - План рефакторинга
- [FEATURES_ROADMAP.md](development/FEATURES_ROADMAP.md) - Дорожная карта функций
- [IMPROVEMENTS_PROPOSAL_RU.md](development/IMPROVEMENTS_PROPOSAL_RU.md) - Предложения по улучшению

### 📝 [Промпты](prompts/)
Промпты для использования в других проектах:
- [WOOCOMMERCE_PRODUCT_STOCK_PROMPT.md](prompts/WOOCOMMERCE_PRODUCT_STOCK_PROMPT.md) - Промпт для получения товаров через API
